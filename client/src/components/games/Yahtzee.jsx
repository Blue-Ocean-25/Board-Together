...
const Yahtzee = () => {
  ...
  return (
    <div className="bg-base-300 flex-col justify-items-center pt-4 pb-4">
      ...
      <div className="bg-base-200 flex-col justify-items-center p-2 shadow-lg w-96 rounded-box border-2 border-base-100">
        ...
        <div className="pt-4 pb-4">
          <button className="btn btn-md btn-accent shadow-lg w-43" onClick={() => makeNewGame()}>Start Yahtzee Game</button>
        </div>
      </div>
    </div>
  );
