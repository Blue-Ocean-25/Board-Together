  ...
  if (loggedIn) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-base-300">
        ...
        <Link to="/selection" data-testid="selection" className="btn btn-accent text-2xl">Go to Selection Page</Link>
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-base-300">
      ...
      <div className="space-x-8">
        <Link to="/login" data-testid="login" className="btn btn-accent text-2xl py-2 px-4">Login</Link>
        <Link to="/signup" data-testid="signup" className="btn btn-neutral text-2xl py-2 px-4">Sign Up</Link>
      </div>
      <small className="fixed bottom-4 right-4 text-lg">Hasbruh&copy;</small>
    </div>
  );
