  ...
  return (
    <div className="navbar bg-base-200 shadow-sm fixed top-0 left-0 w-full z-10">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            ...
            <li><Link data-testid="navbar-home" to="/">Home page</Link></li>
            <li><Link data-testid="navbar-profile" to="/profile">Profile</Link></li>
            <li><Link data-testid="navbar-selection" to="/selection">Selection page</Link></li>
            {loggedIn ? <li><button data-testid="logout" onClick={handleLogout}>Logout</button></li> : <li><Link data-testid="navbar-login" to="/login">Login</Link></li>}
          </ul>
        </div>
      </div>
      ...
      <div className="navbar-end">
        ...
        <button data-testid="notification" onClick={handleNotification} className="btn btn-ghost btn-circle">
